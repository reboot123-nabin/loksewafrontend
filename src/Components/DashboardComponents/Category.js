...
<table id="table">
        <tr>
            <td colspan="2">
                <div class="categoryheader">Choose YOur Categories</div>
            </td>
        </tr>
        <tr>
            <td colspan="4">
        ...
        <tr>
            <td>
                <div class="div-category">
                    ...
                    <button class="btncategory btncategory1">Education</button>
                    <br /><br />
                </div>
            </td>
            <td>
                ...
                <button class="btncategory btncategory2">Music</button>
                <br /><br />
                </div>
            </td>
            <td>
                ...
                <p>Information is not knowledge.The only source of
                         knowledge is experience.Get Involved to achieve</p>
                <button class="btncategory btncategory3">Science</button>
                <br /><br />
                </div>
            </td>
            <td>
                ...
                <p>Information is not knowledge.The only source of
                         knowledge is experience.Get Involved to achieve</p>
                <button class="btncategory btncategory4">History</button>
                <br /><br />
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <div class="div-category">
                    ...
                    <p>Information is not knowledge.The only source of
                         knowledge is experience.Get Involved to achieve.</p>
                    <button class="btncategory btncategory1">Mathematics</button>
                    <br /><br />
                </div>
            </td>
            <td>
                ...
                <p>Information is not knowledge.The only source of
                         knowledge is experience.Get Involved to achieve</p>
                <button class="btncategory btncategory2">Lok Sewa</button>
                <br /><br />
                </div>
            </td>
            <td>
                ...
                <p>Information is not knowledge.The only source of
                         knowledge is experience.Get Involved to achieve</p>
                <button class="btncategory btncategory3">IOM</button>
                <br /><br />
                </div>
            </td>
            <td>
                ...
                <p>Information is not knowledge.The only source of
                         knowledge is experience.Get Involved to achieve</p>
                <button class="btncategory btncategory4">IOE</button>
                <br /><br />
                </div>
            </td>
        </tr>
